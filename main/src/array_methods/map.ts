...
const roots: number[] = numbers.map(number => Number(Math.sqrt(number).toFixed(2)))
console.log(roots);


// using map to reformat objects in an array

const my_array = [{ key: 1, value: "Hello" }, { key: 2, value: "World" }, { key: 3, value: "Structure" }, { key: 4, value: "Books" }]
